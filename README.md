...
```python
from weirwood_pyfinance import Example
...
For full package documentation please visit [weirwoodai.github.io/weirwood_pyfinance](https://weirwoodai.github.io/weirwood_pyfinance).
...
-   Ensure that you have set GitHub pages to build the `gh-pages` branch by selecting the
    ...
    ([Repo Settings](https://github.com/weirwoodai/weirwood_pyfinance/settings))
-   Register your project with PyPI:
    -   Make an account on [pypi.org](https://pypi.org)
    -   Go to your GitHub repository's settings and under the
        [Secrets tab](https://github.com/weirwoodai/weirwood_pyfinance/settings/secrets/actions),
